...
ZEND_METHOD(QApplication, setEffectEnabled){
	...
	if (ZEND_NUM_ARGS() == 2){
		...
		if(zend_parse_parameters(ZEND_NUM_ARGS() TSRMLS_CC,"ob|", &var_ob_0, &var_ob_1) == SUCCESS) {
			...
			if(tmp_0 == "Qt::UIEffect") {
				QApplication *obj = (QApplication) PHP_QT_FETCH();
			obj->setEffectEnabled((Qt::UIEffect) var_o_0, (bool) var_ob_1);
			RETURN_NULL();
			}
		}
	}
...
ZEND_METHOD(QApplication, palette){
	...
	if (ZEND_NUM_ARGS() == 1){
		...
		if(zend_parse_parameters(ZEND_NUM_ARGS() TSRMLS_CC,"s", &var_0, &len_0) == SUCCESS) {
			...
			QApplication *obj = (QApplication) PHP_QT_FETCH();
			QPalette return_object = (QPalette) obj->palette( var_0);
			zend_class_entry *ce;                                   
			object_init_ex(return_value, QApplication_ce_ptr);     
			zend_rsrc_list_entry le;                            
			le.ptr = &return_object;                                       
		...
		if(zend_parse_parameters(ZEND_NUM_ARGS() TSRMLS_CC,"o", &var_o_0) == SUCCESS) {
			...
			if(tmp_0 == "const QWidget*") {
				QApplication *obj = (QApplication) PHP_QT_FETCH();
			QPalette return_object = (QPalette) obj->palette((const QWidget*) var_o_0);
			zend_class_entry *ce;                                   
			object_init_ex(return_value, QApplication_ce_ptr);     
			zend_rsrc_list_entry le;                            
			le.ptr = &return_object;                                       
...
ZEND_METHOD(QApplication, isEffectEnabled){
	...
	if (ZEND_NUM_ARGS() == 1){
		...
		if(zend_parse_parameters(ZEND_NUM_ARGS() TSRMLS_CC,"o", &var_o_0) == SUCCESS) {
			...
			if(tmp_0 == "Qt::UIEffect") {
				QApplication *obj = (QApplication) PHP_QT_FETCH();
			RETURN_BOOL(obj->isEffectEnabled((Qt::UIEffect) var_o_0));
			}
		}
	}
}
	...
	if (ZEND_NUM_ARGS() == 2){
		...
		if(zend_parse_parameters(ZEND_NUM_ARGS() TSRMLS_CC,"os|", &var_os_0, &var_1, &len_1) == SUCCESS) {
			...
			if(tmp_0 == "const QPalette&") {
				QApplication *obj = (QApplication) PHP_QT_FETCH();
			obj->setPalette((const QPalette&) var_o_0, (const char*) var_os_1);
			RETURN_NULL();
			}
		}
	}
	...
	if (ZEND_NUM_ARGS() == 2){
		...
		if(zend_parse_parameters(ZEND_NUM_ARGS() TSRMLS_CC,"os|", &var_os_0, &var_1, &len_1) == SUCCESS) {
			...
			if(tmp_0 == "const QFont&") {
				QApplication *obj = (QApplication) PHP_QT_FETCH();
			obj->setFont((const QFont&) var_o_0, (const char*) var_os_1);
			RETURN_NULL();
			}
		}
	}
