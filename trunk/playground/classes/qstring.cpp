...
ZEND_METHOD(QString, count){
	...
	if (ZEND_NUM_ARGS() == 2){
		...
		if(zend_parse_parameters(ZEND_NUM_ARGS() TSRMLS_CC,"ol|", &z_var_ol_0, &var_ol_1) == SUCCESS) {
			...
			if(tmp_ol_0 == "QChar") {
				RETURN_LONG(obj->count((QChar) var_ol_0, (int) var_ol_1));
			}			
			if(tmp_ol_0 == "const QString&") {
				RETURN_LONG(obj->count((const QString&) var_ol_0, (int) var_ol_3));
			}
		}
	}
}
...
ZEND_METHOD(QString, endsWith){
	...
	if (ZEND_NUM_ARGS() == 2){
		...
		if(zend_parse_parameters(ZEND_NUM_ARGS() TSRMLS_CC,"ol|", &z_var_ol_0, &var_ol_1) == SUCCESS) {
			...
			if(tmp_ol_0 == "const QString&") {
				RETURN_BOOL(obj->endsWith((const QString&) var_ol_0, (int) var_ol_1));
			}			
			if(tmp_ol_0 == "const QChar&") {
				RETURN_BOOL(obj->endsWith((const QChar&) var_ol_0, (int) var_ol_3));
			}
		}
	}
}
...
ZEND_METHOD(QString, indexOf){
	...
	if (ZEND_NUM_ARGS() == 3){
		...
		if(zend_parse_parameters(ZEND_NUM_ARGS() TSRMLS_CC,"ol|l|", &z_var_oll_0, &var_oll_1, &var_oll_2) == SUCCESS) {
			...
			if(tmp_oll_0 == "QChar") {
				RETURN_LONG(obj->indexOf((QChar) var_oll_0, (int) var_oll_1, (int) var_oll_2));
			}			
			if(tmp_oll_0 == "const QString&") {
				RETURN_LONG(obj->indexOf((const QString&) var_oll_0, (int) var_oll_4, (int) var_oll_5));
			}
		}
	}
}
...
ZEND_METHOD(QString, startsWith){
	...
	if (ZEND_NUM_ARGS() == 2){
		...
		if(zend_parse_parameters(ZEND_NUM_ARGS() TSRMLS_CC,"ol|", &z_var_ol_0, &var_ol_1) == SUCCESS) {
			...
			if(tmp_ol_0 == "const QString&") {
				RETURN_BOOL(obj->startsWith((const QString&) var_ol_0, (int) var_ol_1));
			}			
			if(tmp_ol_0 == "const QChar&") {
				RETURN_BOOL(obj->startsWith((const QChar&) var_ol_0, (int) var_ol_3));
			}
		}
	}
}
...
ZEND_METHOD(QString, remove){
	...
	if (ZEND_NUM_ARGS() == 2){
		...
		if(zend_parse_parameters(ZEND_NUM_ARGS() TSRMLS_CC,"ol|", &z_var_ol_0, &var_ol_1) == SUCCESS) {
			...
			if(tmp_ol_0 == "QChar") {
				QString & return_object = (QString &) obj->remove((QChar) var_ol_0, (int) var_ol_1);
			zend_class_entry *ce;                                   
			object_init_ex(return_value, QString_ce_ptr);     
			zend_rsrc_list_entry le;                            
			le.ptr = &return_object;                                       
			...
			if(tmp_ol_0 == "const QString&") {
				QString & return_object = (QString &) obj->remove((const QString&) var_ol_0, (int) var_ol_3);
			zend_class_entry *ce;                                   
			object_init_ex(return_value, QString_ce_ptr);     
			zend_rsrc_list_entry le;                            
			le.ptr = &return_object;                                       
	...
	if (ZEND_NUM_ARGS() == 3){
		...
		if(zend_parse_parameters(ZEND_NUM_ARGS() TSRMLS_CC,"oo|l|", &z_var_ool_0, &z_var_ool_1, &var_ool_2) == SUCCESS) {
			...
			if(tmp_ool_0 == "const QString&" && tmp_ool_1 == "SplitBehavior") {
				QStringList return_object = (QStringList) obj->split((const QString&) var_ool_0, (SplitBehavior) var_ool_1, (int) var_ool_2);
			zend_class_entry *ce;                                   
			object_init_ex(return_value, QString_ce_ptr);     
			zend_rsrc_list_entry le;                            
			le.ptr = &return_object;                                       
	...
	if (ZEND_NUM_ARGS() == 3){
		...
		if(zend_parse_parameters(ZEND_NUM_ARGS() TSRMLS_CC,"ool|", &z_var_ool_0, &z_var_ool_1, &var_ool_2) == SUCCESS) {
			...
			if(tmp_ool_0 == "QChar" && tmp_ool_1 == "QChar") {
				QString & return_object = (QString &) obj->replace((QChar) var_ool_0, (QChar) var_ool_1, (int) var_ool_2);
			zend_class_entry *ce;                                   
			object_init_ex(return_value, QString_ce_ptr);     
			zend_rsrc_list_entry le;                            
			le.ptr = &return_object;                                       
			...
			if(tmp_ool_0 == "QChar" && tmp_ool_1 == "const QString&") {
				QString & return_object = (QString &) obj->replace((QChar) var_ool_0, (const QString&) var_ool_1, (int) var_ool_5);
			zend_class_entry *ce;                                   
			object_init_ex(return_value, QString_ce_ptr);     
			zend_rsrc_list_entry le;                            
			le.ptr = &return_object;                                       
			...
			if(tmp_ool_0 == "const QString&" && tmp_ool_1 == "const QString&") {
				QString & return_object = (QString &) obj->replace((const QString&) var_ool_0, (const QString&) var_ool_1, (int) var_ool_8);
			zend_class_entry *ce;                                   
			object_init_ex(return_value, QString_ce_ptr);     
			zend_rsrc_list_entry le;                            
			le.ptr = &return_object;                                       
...
ZEND_METHOD(QString, lastIndexOf){
	...
	if (ZEND_NUM_ARGS() == 3){
		...
		if(zend_parse_parameters(ZEND_NUM_ARGS() TSRMLS_CC,"ol|l|", &z_var_oll_0, &var_oll_1, &var_oll_2) == SUCCESS) {
			...
			if(tmp_oll_0 == "QChar") {
				RETURN_LONG(obj->lastIndexOf((QChar) var_oll_0, (int) var_oll_1, (int) var_oll_2));
			}			
			if(tmp_oll_0 == "const QString&") {
				RETURN_LONG(obj->lastIndexOf((const QString&) var_oll_0, (int) var_oll_4, (int) var_oll_5));
			}
		}
	}
}
