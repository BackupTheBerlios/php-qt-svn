	...
	if (ZEND_NUM_ARGS() == 2){
		...
		if(zend_parse_parameters(ZEND_NUM_ARGS() TSRMLS_CC,"ol|", &z_var_ol_0, &var_ol_1) == SUCCESS) {
			...
			if(tmp_ol_0 == "const QKeySequence&") {
				RETURN_LONG(obj->grabShortcut((const QKeySequence&) var_ol_0, (int) var_ol_1));
			}
		}
	}
}
...
ZEND_METHOD(QWidget, setParent){
	...
	if (ZEND_NUM_ARGS() == 2){
		...
		if(zend_parse_parameters(ZEND_NUM_ARGS() TSRMLS_CC,"ol", &z_var_ol_0, &var_ol_1) == SUCCESS) {
			...
			if(tmp_ol_0 == "QWidget*") {
				obj->setParent((QWidget*) var_ol_0, (int) var_ol_1);
			RETURN_NULL();
			}
		}
	}
...
ZEND_METHOD(QWidget, create){
	...
	if (ZEND_NUM_ARGS() == 3){
		...
		long* var_obb_1;   // _default: true
		long* var_obb_2;   // _default: true
...
ZEND_METHOD(QWidget, destroy){
	...
	if (ZEND_NUM_ARGS() == 2){
		/* bb */
		long* var_bb_0;   // _default: true
		long* var_bb_1;   // _default: true
