...
ZEND_METHOD(QPainter, setClipRect){
	...
	if (ZEND_NUM_ARGS() == 2){
		...
		if(zend_parse_parameters(ZEND_NUM_ARGS() TSRMLS_CC,"ol|", &z_var_ol_0, &var_ol_1) == SUCCESS) {
			...
			if(tmp_ol_0 == "const QRectF&") {
				obj->setClipRect((const QRectF&) var_ol_0, (int) var_ol_1);
			RETURN_NULL();
			}
		}
	}
	...
	if (ZEND_NUM_ARGS() == 4){
		...
		if(zend_parse_parameters(ZEND_NUM_ARGS() TSRMLS_CC,"oool|", &z_var_oool_0, &z_var_oool_1, &z_var_oool_2, &var_oool_3) == SUCCESS) {
			...
			if(tmp_oool_0 == "const QRectF&" && tmp_oool_1 == "const QImage&" && tmp_oool_2 == "const QRectF&") {
				obj->drawImage((const QRectF&) var_oool_0, (const QImage&) var_oool_1, (const QRectF&) var_oool_2, (int) var_oool_3);
			RETURN_NULL();
			}
		}
		/* lool */
		...
		if(zend_parse_parameters(ZEND_NUM_ARGS() TSRMLS_CC,"lool|", &var_lool_4, &z_var_lool_5, &z_var_lool_6, &var_lool_7) == SUCCESS) {
			...
			if(tmp_lool_0 == "const QImage&" && tmp_lool_1 == "const QRectF&") {
				obj->drawImage((const QPointF&) var_lool_4, (const QImage&) var_lool_5, (const QRectF&) var_lool_6, (int) var_lool_7);
			RETURN_NULL();
			}			
			if(tmp_lool_0 == "const QImage&" && tmp_lool_1 == "const QRect&") {
				obj->drawImage((const QPoint&) var_lool_8, (const QImage&) var_lool_5, (const QRect&) var_lool_6, (int) var_lool_11);
			RETURN_NULL();
			}
		}
	}
	...
	if (ZEND_NUM_ARGS() == 2){
		...
		if(zend_parse_parameters(ZEND_NUM_ARGS() TSRMLS_CC,"ol|", &z_var_ol_0, &var_ol_1) == SUCCESS) {
			...
			if(tmp_ol_0 == "const QPolygonF&") {
				obj->drawPolygon((const QPolygonF&) var_ol_0, (int) var_ol_1);
			RETURN_NULL();
			}			
			if(tmp_ol_0 == "const QPolygon&") {
				obj->drawPolygon((const QPolygon&) var_ol_0, (int) var_ol_3);
			RETURN_NULL();
			}
		}
	}
	...
	if (ZEND_NUM_ARGS() == 2){
		...
		if(zend_parse_parameters(ZEND_NUM_ARGS() TSRMLS_CC,"ol|", &z_var_ol_0, &var_ol_1) == SUCCESS) {
			...
			if(tmp_ol_0 == "const QRegion&") {
				obj->setClipRegion((const QRegion&) var_ol_0, (int) var_ol_1);
			RETURN_NULL();
			}
		}
	}
