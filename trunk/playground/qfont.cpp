	...
	if (ZEND_NUM_ARGS() == 2){
		...
		if(zend_parse_parameters(ZEND_NUM_ARGS() TSRMLS_CC,"oo", &var_oo_0, &var_oo_1) == SUCCESS) {
			...
			if(tmp_0 == "const QString&" && tmp_1 == "const QString&") {
				QFont *obj = (QFont) PHP_QT_FETCH();
			obj->insertSubstitution((const QString&) var_o_0, (const QString&) var_o_1);
			RETURN_NULL();
			}
		}
	}
...
ZEND_METHOD(QFont, insertSubstitutions){
	...
	if (ZEND_NUM_ARGS() == 2){
		...
		if(zend_parse_parameters(ZEND_NUM_ARGS() TSRMLS_CC,"oo", &var_oo_0, &var_oo_1) == SUCCESS) {
			...
			if(tmp_0 == "const QString&" && tmp_1 == "const QStringList&") {
				QFont *obj = (QFont) PHP_QT_FETCH();
			obj->insertSubstitutions((const QString&) var_o_0, (const QStringList&) var_o_1);
			RETURN_NULL();
			}
		}
	}
...
ZEND_METHOD(QFont, setStyleHint){
	...
	if (ZEND_NUM_ARGS() == 2){
		...
		zval* var_lo_1;   // default: PreferDefault
		...
		if(zend_parse_parameters(ZEND_NUM_ARGS() TSRMLS_CC,"lo|", &var_lo_0, &var_lo_1) == SUCCESS) {
			...
			if(tmp_0 == "StyleStrategy") {
				QFont *obj = (QFont) PHP_QT_FETCH();
			obj->setStyleHint((StyleHint) var_lo_0, (StyleStrategy) var_o_1);
			RETURN_NULL();
			}
		}
	}
