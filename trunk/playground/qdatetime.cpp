...
ZEND_METHOD(QDateTime, toString){
	...
	if (ZEND_NUM_ARGS() == 1){
		/* o */
		zval* var_o_0;   // default: Qt::TextDate
		...
		if(zend_parse_parameters(ZEND_NUM_ARGS() TSRMLS_CC,"o|", &var_o_0) == SUCCESS) {
			...
			if(tmp_0 == "Qt::DateFormat") {
				QDateTime *obj = (QDateTime) PHP_QT_FETCH();
			QString return_object = (QString) obj->toString((Qt::DateFormat) var_o_0);
			zend_class_entry *ce;                                   
			object_init_ex(return_value, QDateTime_ce_ptr);     
			zend_rsrc_list_entry le;                            
			le.ptr = &return_object;                                       
...
ZEND_METHOD(QDateTime, toTimeSpec){
	...
	if (ZEND_NUM_ARGS() == 1){
		...
		if(zend_parse_parameters(ZEND_NUM_ARGS() TSRMLS_CC,"o", &var_o_0) == SUCCESS) {
			...
			if(tmp_0 == "Qt::TimeSpec") {
				QDateTime *obj = (QDateTime) PHP_QT_FETCH();
			QDateTime return_object = (QDateTime) obj->toTimeSpec((Qt::TimeSpec) var_o_0);
			zend_class_entry *ce;                                   
			object_init_ex(return_value, QDateTime_ce_ptr);     
			zend_rsrc_list_entry le;                            
			le.ptr = &return_object;                                       
...
ZEND_METHOD(QDateTime, fromString){
	...
	if (ZEND_NUM_ARGS() == 2){
		...
		zval* var_oo_1;   // default: Qt::TextDate
		...
		if(zend_parse_parameters(ZEND_NUM_ARGS() TSRMLS_CC,"oo|", &var_oo_0, &var_oo_1) == SUCCESS) {
			...
			if(tmp_0 == "const QString&" && tmp_1 == "Qt::DateFormat") {
				QDateTime *obj = (QDateTime) PHP_QT_FETCH();
			QDateTime return_object = (QDateTime) obj->fromString((const QString&) var_o_0, (Qt::DateFormat) var_o_1);
			zend_class_entry *ce;                                   
			object_init_ex(return_value, QDateTime_ce_ptr);     
			zend_rsrc_list_entry le;                            
			le.ptr = &return_object;                                       
			...
			if(tmp_0 == "const QString&" && tmp_1 == "const QString&") {
				QDateTime *obj = (QDateTime) PHP_QT_FETCH();
			QDateTime return_object = (QDateTime) obj->fromString((const QString&) var_o_0, (const QString&) var_o_1);
			zend_class_entry *ce;                                   
			object_init_ex(return_value, QDateTime_ce_ptr);     
			zend_rsrc_list_entry le;                            
			le.ptr = &return_object;                                       
...
ZEND_METHOD(QDateTime, setTimeSpec){
	...
	if (ZEND_NUM_ARGS() == 1){
		...
		if(zend_parse_parameters(ZEND_NUM_ARGS() TSRMLS_CC,"o", &var_o_0) == SUCCESS) {
			...
			if(tmp_0 == "Qt::TimeSpec") {
				QDateTime *obj = (QDateTime) PHP_QT_FETCH();
			obj->setTimeSpec((Qt::TimeSpec) var_o_0);
			RETURN_NULL();
			}
		}
	}
